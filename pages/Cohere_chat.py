...
from utils.upload import create_or_update_index, index_documents, extract_text_from_pdf  
...
# Streamlit UI  
st.set_page_config(page_title="Cohere AI Assistant", page_icon="🤖", layout="wide")  
...
st.header('Upload & Ask Questions', divider='rainbow')  
